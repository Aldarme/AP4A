...
private:
    ...
    void fileWrite(); //écrit les résultat de nos sensors dans le fichier commun (pour rendu intermédiaire)
    void consolWrite(); //écrit les résultats de nos sensors dans la console
public:
