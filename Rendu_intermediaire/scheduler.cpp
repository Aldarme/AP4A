...
void Scheduler::startSimulation()
{
    ...
    {
        this->data[0] = this->m_humidite.getData();
        this->data[1] = this->m_temperature.getData();
        this->data[2] = this->m_pression.getData();
        this->data[3] = this->m_light.getData();

        this->m_server.consolWrite(this->m_humidite.getName(), this->data[0], this->m_humidite.getUnite());
        this->m_server.consolWrite(this->m_light.getName(), this->data[3], this->m_light.getUnite());
        this->m_server.consolWrite(this->m_temperature.getName(), this->data[1], this->m_temperature.getUnite());
        this->m_server.consolWrite(this->m_pression.getName(), this->data[2], this->m_pression.getUnite());
        this->m_server.fileWrite(this->m_humidite.getName(), this->data[0], this->m_humidite.getUnite());
        this->m_server.fileWrite(this->m_light.getName(), this->data[3], this->m_light.getUnite());
        this->m_server.fileWrite(this->m_temperature.getName(), this->data[1], this->m_temperature.getUnite());
        this->m_server.fileWrite(this->m_pression.getName(), this->data[2], this->m_pression.getUnite());
        sleep(1);
    }
}