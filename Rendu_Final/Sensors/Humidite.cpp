 ...
 * @file Humidite.cpp
 * @date 03/10/2022
 * @brief Fichier source contenant l'implémentation des méthodes de la classe Humidité
 */
...
Humidite::Humidite(const Humidite &h_p) : Sensor<float>(h_p) {} // Utilise le constructeur par recopiage de Sensor
