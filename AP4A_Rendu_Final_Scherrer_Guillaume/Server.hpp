...
public: 
    ...
    *
    */
    void UpdateValues(ValeursCapteurs &, int);

    /** 
    * @brief fonciton qui sert uniquement à fermer les fichiers de logs
    * @return rien car de type void
    * @param pointeur sur un tableau
    *
    */
    ...
    std::fstream PressureFile; // fichier de logs pour capteur de pression
    std::fstream TemperatureFile; // fichier de logs pour capteur de température
    std::fstream HumidityFile; // fichier de logs pour capteur d'humidité
    std::fstream LightFile; // fichier de logs pour capteur de lumière
};
