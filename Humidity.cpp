...
* @file Humidity.hpp
* @date 06/10/2022
* @brief Fichier source contenant les méthodes de la classe Humidity
*/
...
Humidity::Humidity()
{
    this->m_maxValue = 50.0;  //Valeur maximale que peut prendre le capteur en %
    this->m_minValue = 30.0;  //Valeur minimale que peut prendre le capteur en %
}
